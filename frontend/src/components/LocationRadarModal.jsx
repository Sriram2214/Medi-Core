          ...
          {loading ? (
            ...
            <div className="radar-results-grid">
              {facilities.map((item, idx) => (
                <div key={idx} className="radar-item-card animate-fadeIn">
                  ...
                  <div className="radar-item-footer">
                    ...
                    {item.category === 'Hospital' && onSelectHospital && (
                      <button
                        ...
                        style={{ padding: '0.4rem 0.8rem', background: '#0f6b6b', color: 'white', border: 'none', borderRadius: '10px', fontSize: '0.8rem', fontWeight: '700', cursor: 'pointer' }}
                      >
                        Select Hospital ➔
                      </button>
                    )}
